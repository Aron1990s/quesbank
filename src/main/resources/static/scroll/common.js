...
(function(exports) {
    ...
    exports.appendTestData = function(dom, count, isReset, index) {
        ...
        var template = '<li class="list-item"><div class="recordContainer bounceInDown dialog" onclick="aa(INDEX)"><div class="showBody"><div class="content"><div id="content" contentEditable="false" class="showDemo">AAAA</div></div></div></div><div style="height: 3%"></div></li>';
        ...
        $.ajax({
            ...
            success : function(data) {
                var con = '<div class="recordContainer bounceInDown dialog" onclick="aa(INDEX)"><div class="showBody"><div class="content"><div id="content" contentEditable="false" class="showDemo">AAAA</div></div></div></div><div style="height: 3%"></div>';
                for(var i = 0; i<data.demo.length;i++){
                    var con1 = template.replace('INDEX',i).replace('AAAA',data.demo[i].content);
                    html += con1;
                }
            }
        });
