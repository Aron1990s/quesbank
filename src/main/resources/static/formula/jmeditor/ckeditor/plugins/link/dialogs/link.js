...
CKEDITOR.dialog.add("link", function (n) {
    ...
    var w = CKEDITOR.plugins.link, s = function () {
            var a = this.getDialog(), g = a.getContentElement("target", "popupFeatures"),
                a = a.getContentElement("target", "linkTargetName"), c = this.getValue();
        ...
        z = /subject=([^;?:@&=$,\/]*)/, A = /body=([^;?:@&=$,\/]*)/, B = /^#(.*)$/,
        C = /^((?:http|https|ftp|news):\/\/)?(.*)$/, D = /^(_(?:self|top|parent|blank))$/,
    ...
    return {
        title: b.title, minWidth: 350, minHeight: 230, contents: [{
            id: "info", label: b.info, title: b.info, elements: [{
                ...
                onChange: function () {
                    var a =
                            this.getDialog(), b = ["urlOptions", "anchorOptions", "emailOptions"], c = this.getValue(),
            ...
            id: "target", label: b.target, title: b.target, elements: [{
                ...
                children: [{
                    ...
                    type: "text", id: "linkTargetName", label: b.targetFrameName,
                ...
                type: "vbox", width: "100%", align: "center", padding: 2, id: "popupFeatures", children: [{
                    ...
                    children: [{
                        ...
                        type: "hbox", children: [{
                            type: "checkbox",
                            id: "location", label: b.popupLocationBar, setup: j, commit: l
            ...
            id: "upload", label: b.upload, title: b.upload, hidden: !0, filebrowser: "uploadButton",
            elements: [{
                type: "file",
                id: "upload",
                label: i.upload,
            ...
            id: "advanced", label: b.advanced, title: b.advanced, elements: [{
                type: "vbox", padding: 1, children: [{
                    type: "hbox",
                    widths: ["45%", "35%", "20%"],
                    children: [{type: "text", id: "advId", label: b.id, setup: k, commit: m}, {
                        type: "select",
                        id: "advLangDir",
                        label: b.langDir,
                        "default": "",
                        style: "width:110px",
                        items: [[i.notSet, ""], [b.langDirLTR, "ltr"],
                            [b.langDirRTL, "rtl"]],
                        setup: k,
                        commit: m
                    }, {
                    ...
                    type: "hbox",
                    widths: ["45%", "35%", "20%"],
                    children: [{type: "text", label: b.name, id: "advName", setup: k, commit: m}, {
                        type: "text",
                        label: b.langCode,
                        id: "advLangCode",
                        width: "110px",
                ...
                type: "vbox", padding: 1, children: [{
                    type: "hbox", widths: ["45%", "55%"], children: [{
                        type: "text",
                        label: b.advisoryTitle, "default": "", id: "advTitle", setup: k, commit: m
                    }, {
                        type: "text",
                    ...
                    children: [{
                        ...
                        setup: k,
                        commit: m
                    }, {type: "text", label: b.charset, "default": "", id: "advCharset", setup: k, commit: m}]
                }, {
                    type: "hbox",
                    widths: ["45%", "55%"],
                    children: [{type: "text", label: b.rel, "default": "", id: "advRel", setup: k, commit: m}, {
                        type: "text",
                        label: b.styles,
                        "default": "",
                        id: "advStyles",
            ...
            switch (c.type || "url") {
                case "url":
                    var e = c.url && c.url.protocol != void 0 ? c.url.protocol : "http://", i = c.url &&
                        CKEDITOR.tools.trim(c.url.url) || "";
            ...
            if (this._.selectedElement) {
                ...
                if (i == f || c.type == "email" && f.indexOf("@") != -1) d.setHtml(c.type ==
                "email" ? c.email.address : a["data-cke-saved-href"]);
                e.selectElement(d);
